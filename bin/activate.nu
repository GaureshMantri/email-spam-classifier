...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/gaureshmantri/PycharmProjects/spam-sms-detector/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/gaureshmantri/PycharmProjects/spam-sms-detector/venv/bin/deactivate.nu'
